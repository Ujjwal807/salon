      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8 mb-8 sm:mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <div className="mb-4 sm:mb-6">
              ...
              <p className="text-xs sm:text-sm text-gray-400">Beauty & Wellness</p>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              >
                <Instagram size={16} className="sm:w-[18px] sm:h-[18px] text-gray-900" />
              </a>
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
              ...
              >
                <Facebook size={16} className="sm:w-[18px] sm:h-[18px] text-gray-900" />
              </a>
              <a
                href="#"
                className="w-9 h-9 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
              ...
              >
                <Twitter size={16} className="sm:w-[18px] sm:h-[18px] text-gray-900" />
              </a>
            </div>
          </div>
          ...
          <div className="sm:col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <a href="#services" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">
                  Services
                </a>
              </li>
              <li>
          ...
          <div className="sm:col-span-1">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3">
                ...
                <span className="text-xs sm:text-sm text-gray-400 leading-relaxed">Pimpri-Chinchwad, Pune</span>
              </div>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 text-center">
          <p className="text-sm sm:text-base text-gray-400 flex items-center justify-center gap-2 mb-2 sm:mb-3">
            Made with <Heart size={14} className="text-gray-400 sm:w-4 sm:h-4" /> for beautiful you
          </p>
